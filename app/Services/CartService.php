...
class CartService
{
    ...
    public function toggleSelect(int $productId = null, bool $selected = true): void
    {
        $cart = session(self::SESSION_KEY, []);
    ...
    {
        return (int) $this->selectedItems()->sum(function ($item) {
    ...
    {
        return (int) $this->selectedItems()->sum('subtotal');
    }
